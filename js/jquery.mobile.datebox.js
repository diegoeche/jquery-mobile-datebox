  ...
  $.widget( "mobile.datebox", $.mobile.widget, {
    ...
    _update: function() {
      ...
      if ( o.mode === 'calbox' ) { // Meat and potatos - make the calendar grid.
        ...
        calmode.checkDates = ( o.afterToday !== false || o.beforeToday !== false || o.notToday !== false || o.maxDays !== false || o.minDays !== false || o.blackDates !== false || o.blackDays !== false || o.whiteDates !== false );
            ...
            for ( gridDay=0; gridDay<=6; gridDay++) {
              ...
              if ( calmode.today < 1 ) {
                if ( o.calShowOnlyMonth ) {
                  ...
                  if (
                    ( o.blackDays !== false && $.inArray(gridDay, o.blackDays) > -1 ) ||
                      ...
                      ( o.whiteDates !== false && $.inArray(self._isoDate(self.theDate.getFullYear(), (self.theDate.getMonth()), calmode.prevtoday), o.whiteDates) == -1 ) ||
                      ( o.whiteDates !== false && $.inArray(self._isoDate(self.theDate.getFullYear(), (self.theDate.getMonth()+2), calmode.nexttoday), o.whiteDates) == -1 ) ) {
                    skipThis = true;
                  } else { skipThis = false; }
                ...
                if ( calmode.checkDates ) {
                  ...
                  if ( !skipThis && o.whiteDates !== false ) { // Whitelists
                    var isoDate = self._isoDate(self.theDate.getFullYear(), self.theDate.getMonth()+1, calmode.today);
                    if ( $.inArray(isoDate, o.whiteDates) == -1 ) {
                      skipThis = true;
                    }
                  }
                }
